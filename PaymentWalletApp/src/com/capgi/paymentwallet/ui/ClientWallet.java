package com.capgi.paymentwallet.ui;

import java.util.Scanner;

import com.capgi.paymentwallet.bean.Account;
import com.capgi.paymentwallet.bean.Customer;
import com.capgi.paymentwallet.exception.NoUserNameFoundException;
import com.capgi.paymentwallet.service.PaymentWalletService;
			...
			do {
				...
				case 1:
					...
					*/
					...
					if(isValidadharNumber &&  isValidphoneNumber )
					{
						...
						//account.setBalance(initBal);
						wallet.setEmail(email);
						wallet.setPhoneNumber(phoneNumber);
						account.setAccountNumber(accountNumber);
						
						b= service.addCustomerDetails(wallet);
						if(b)
						{
				...
				
					{
						do {
							...
							case 4:
								...
								boolean b1= service.fundTransfer(accountNumber,amount);
								if(b1)
								{
